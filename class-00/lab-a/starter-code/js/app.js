...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: the error was that 'rando is not defined'. This is explained by the fact that the console.log was made out of the block in which rando was declared.
  console.log(viewed);
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    liEl.textContent = `${allProducts[i].name} has ${allProducts[i].votes} voyes in ${allProducts[i].views} views`;
